 ...
 * Generated at: 2023-09-21 00:55:24 UTC
...
public final class Board_005fList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/C:/Users/V15%20G3/Desktop/board/SMT/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SMT/WEB-INF/lib/jstl-1.2.jar!/META-INF/c.tld", Long.valueOf(1153352682000L));
    _jspx_dependants.put("jar:file:/C:/Users/V15%20G3/Desktop/board/SMT/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SMT/WEB-INF/lib/jstl-1.2.jar!/META-INF/fn.tld", Long.valueOf(1153352682000L));
    _jspx_dependants.put("/WEB-INF/lib/jstl-1.2.jar", Long.valueOf(1694652344643L));
    _jspx_dependants.put("/WEB-INF/Board/../../../header.jsp", Long.valueOf(1694651946595L));
    _jspx_dependants.put("/WEB-INF/Board/../../../footer.jsp", Long.valueOf(1694651954217L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("					<option value=\"comment_ID\">작성자명</option>\r\n");
      out.write("				</select>\r\n");
      out.write("				<input type=\"text\" id=\"searchKeyword\" class=\"form-control\" name=\"searchKeyword\" maxlength=\"20\">\r\n");
      out.write("				<button type=\"button\" class=\"btn\" onClick=\"getQuesList()\">\r\n");
      out.write("				<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"25\" height=\"25\" fill=\"currentColor\" class=\"bi bi-search\" viewBox=\"0 0 16 16\">\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("function isNewPost(Write_Time) {\r\n");
      out.write("    var currentTime = new Date();\r\n");
      out.write("    var postTime = new Date(Write_Time);\r\n");
      out.write("\r\n");
      out.write("    // 게시글 작성 시간과 현재 시간의 차이를 계산 (밀리초 단위)\r\n");
      out.write("    var timeDifference = currentTime - postTime;\r\n");
      out.write("\r\n");
      out.write("    // 24시간 이내에 작성된 글이면 true 반환, 그렇지 않으면 false 반환\r\n");
      out.write("    if(timeDifference <= 24 * 60 * 60 * 1000 ){\r\n");
      out.write("    	var newImage = document.createElement(\"img\");\r\n");
      out.write("    	newImage.src = \"images/new.png\";\r\n");
      out.write("    	newImage.width = 30; \r\n");
      out.write("    	newImage.alt = \"new\";\r\n");
      out.write("    	return newImage;\r\n");
      out.write("    }else{\r\n");
      out.write("    	return \"\";\r\n");
      out.write("    }		\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function Isread(page_counter) {\r\n");
      out.write("    var page_counter = parseInt(page_counter);\r\n");
      out.write("    \r\n");
      out.write("    if (page_counter > 0) {\r\n");
      out.write("        var checkedImage = document.createElement(\"img\");\r\n");
      out.write("        checkedImage.src = \"images/checked.jpg\";\r\n");
      out.write("        checkedImage.width = 30;\r\n");
      out.write("        checkedImage.alt = \"checked\";\r\n");
      out.write("        return checkedImage;\r\n");
      out.write("    } else {\r\n");
      out.write("        return \"\"; // 이미지를 반환하지 않는 경우 빈 문자열 반환\r\n");
      out.write("    }\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("				comment_html += \"<th scope='col' class='th-status'>상태</th>\";\r\n");
      ...
      out.write("				comment_html += \"<th scope='col'>조회수</th>\";\r\n");
      out.write("				comment_html += \"</tr>\";\r\n");
      out.write("				comment_html += \"</thead>\";\r\n");
      out.write("				comment_html += \"<tr>\";\r\n");
      ...
      out.write("					var answerCnt = bList[i].answerCnt;\r\n");
      out.write("					var write_time = bList[i].Write_Time;\r\n");
      out.write("					var isNew = isNewPost(ins_Date_Time);\r\n");
      out.write("					var write_time = bList[i].Write_Time;\r\n");
      out.write("					var page_counter = bList[i].page_Counter;\r\n");
      out.write("			        var newBadge = isNew ? \"<span class='newBadge'>new</span>\" : \"\";\r\n");
      out.write("					\r\n");
      out.write("					comment_html += \"<tr OnClick='BoardInfo(\"+ board_ID + \")' class='boardList'>\";\r\n");
      out.write("					comment_html += \"<td class='td-num'>\" + board_ID + \"</td>\";\r\n");
      out.write("\r\n");
      out.write("					if(answerCnt > 0){\r\n");
      out.write("						comment_html += \"<td><span class='ansStatusOK'>답변완료</span></td>\";\r\n");
      out.write("					}else{\r\n");
      out.write("						comment_html += \"<td><span class='ansStatusNO'>답변대기</span></td>\";\r\n");
      out.write("					}\r\n");
      out.write("					\r\n");
      out.write("					comment_html += \"<td>\";\r\n");
      out.write("					var newImage = isNewPost(write_time);\r\n");
      out.write("					if (newImage) {\r\n");
      out.write("					    comment_html += newImage.outerHTML; // <img> 요소를 추가합니다.\r\n");
      out.write("					}\r\n");
      out.write("					comment_html += title;\r\n");
      out.write("					var readImage = Isread(page_counter);\r\n");
      out.write("					if (readImage) {\r\n");
      out.write("						comment_html += readImage.outerHTML;\r\n");
      out.write("					}\r\n");
      out.write("					comment_html += \"</td>\";\r\n");
      out.write("					\r\n");
      out.write("					\r\n");
      out.write("					//if(isNewPost(wirte_Time) == true){\r\n");
      out.write("					//	comment_html += \"<td>new</td>\";\r\n");
      out.write("					//}\r\n");
      out.write("					//else{\r\n");
      out.write("					//	comment_html += \"<td>안뜸</td>\";\r\n");
      out.write("					//}\r\n");
      out.write("					\r\n");
      out.write("					comment_html += \"<td>\" + comment_ID + \"</td>\";\r\n");
      out.write("					comment_html += \"<td>\" + ins_Date_Time + \"</td>\";\r\n");
      out.write("					comment_html += \"<td>\" + page_counter + \"</td>\";\r\n");
      out.write("					comment_html += \"</tr>\";\r\n");
      out.write("					\r\n");
      out.write("					}\r\n");
      out.write("				\r\n");
      ...
      out.write("					comment_html += \"<span class='insBtnSpan'>문의하기</span>\";\r\n");
      ...
      out.write("			pageBtn_html += \"\";    	\r\n");
      out.write("	    }\r\n");
      out.write("					$(\"#boardListDiv\").html(comment_html);\r\n");
      out.write("			    	$(\"#pageBtns\").html(pageBtn_html);\r\n");
      out.write("					var boardCnt = \"총 게시글\\t\" + pageInfo.listNum;\r\n");
      out.write("					$(\"#boardCnt\").html(boardCnt);\r\n");
      out.write("    },\r\n");
