...
<div>
<span id="pageCounter">${list.page_Counter}</span>
</div>

<p>현재 페이지 카운터: <span id="counterDisplay"></span></p>
...
$(document).ready(function() {
    ...
    var pageCounter = parseInt("${list.page_Counter}");
    pageCounter++;
    $("#counterDisplay").text(pageCounter);
